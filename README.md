...
INSERT INTO player(NAME, position, team_id, is_outer, created_at) VALUES('곽빈', '투수', 2, 0,NOW());
INSERT INTO player(NAME, position, team_id, is_outer, created_at) VALUES('이정후', '외야수', 3, 0,NOW());
COMMIT;
```
```
